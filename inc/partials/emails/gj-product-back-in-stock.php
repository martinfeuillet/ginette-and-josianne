...
/**
 * Sends an email notification when a product is back in stock.
 *
 ...
 */
function send_back_in_stock_email($product_name, $product_url, $product_thumbnail) {
    $content = '
    <!DOCTYPE html>
        <html>
        <head>
                        ...
                        <table cellpadding="0" cellspacing="0" align="center"
                            ...
                            <tr>
                                <td align="center"
                                    ...
                                    target="_blank"
                                        style="color:#565656;text-decoration:none">
                                        Bonne nouvelle, ta pépite préférée <b>est de retour</b> sur notre eshop.
                                    </a>
                                    </td>
                            </tr>
                            <tr>
                                <td align="center"
                                    ...
                                    target="_blank"
                                        style="color:#565656;text-decoration:none">
                                        Cette fois, pas question <b>de la laisser filer</b>. 
                                    </a>
                                    </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                style="padding:0px 20px 0px">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" style="width:2%;background-color: white;">
                                        </td>
                                        <td align="center" style="width: 49%;">
                                            <p style="padding:0px 0px 0px;font-weight:bold;font-size:18px;color:#565656;text-transform: uppercase;">'. $product_name .'</p>
                                            <a href="'. $product_url .'"
                                            target="_blank"
                                            style="font-size:11px;font-weight:bold;color: #FFFFFF;text-decoration:none;text-transform:uppercase; padding:12px 22px;background-color:#C35939;border-radius:20px;display: inline-block;">Je veux l\'acheter !</a>
                                        </td>
                                    </tr>
                                    </table>
                                </td>
